    ...
    if (!TwCheese.hasTool(toolId)) {
        ...
        class HaulStatsWidget_HaulStatsWidget extends AbstractWidget["a" /* AbstractWidget */] {
            ...
            createHtml() {
                ...
                let pageInfo = this.pageNumber ? `az ${this.pageNumber}. oldalról` : '';
                    ...
                    <div id="twcheese_pillaging_stats" class="vis widget">
                        <h4>
                            ...
                            <span style="font-size: 10px; font-style: normal; font-weight: normal; margin-right: 25px; float: right;">
                                créé par : <a target="_blank" href="https://forum.tribalwars.net/index.php?members/28484/">cheesasaurus</a>
                            </span>
                        </h4>
                        <div id="twcheese_pillaging_stats_content" style="display: ${contentDisplay};">
                            ...
                            <div class="twcheese-pillaging-stats-summation">
                                <div style="text-align: center; width: 100%; margin-top: 5px; margin-bottom: 5px;">
                                    <select id="twcheese_pillaging_stats_from">${summationFromOptions.join('')}</select>-de
                                    <select id="twcheese_pillaging_stats_to">${summationToOptions.join('')}</select>-à
                                </div>
                            ...
                            <table class="twcheese-pillaging-stats-hourly-breakdown" width="100%">
                                <tbody>
                                    <tr><td colspan="6" style="text-align: center; font-size: 16px;">Ressources entrantes ${pageInfo}</td></tr>
                                    <tr>
                                        <th>Arrivée</th>
        ...
        function promptLoadHauls(onConfirm) {
            ...
            async function runRetrieveData() {
                document.getElementById('twcheese_servant_text').innerHTML = '<br/>Que le fromage soit avec toi.'
                ...
                <div style="height: 100%; width: 100%; background: url('${ImageSrc["a" /* ImageSrc */].popupBackground}')">
                    <div style="background: no-repeat url('${ImageSrc["a" /* ImageSrc */].servant}');">
                        <div id="twcheese_servant_text">
                            <p style="font-size: 16px;">Bienvenue,</p>
                            <p>Souhaites-tu afficher les pillages ?</p>
                        </div>
                                ...
                                <tbody>
                                    <tr>
                                        <td id="twcheese_servant_info_prompt" class="twcheese-servant-info">
                                            <h5>Chargement des informations de farm ?</h5>
                                            <p>Cela peut prendre un certain temps s'il y a beaucoup de commandes.</p>
                                            <div class="confirmation-buttons">
                                                <button id="twcheese_hauls_prompt_confirm" class="btn btn-confirm-yes">Oui</button>
                                                <button id="twcheese_hauls_prompt_cancel" class="btn btn-default">Non</button>
                                            </div>
                                        </td>
                                        <td id="twcheese_servant_info_loading" class="twcheese-servant-info" style="display: none;">
                                            <h5>Chargement des pillages</h5>
        ...
        function buildContent(message, options) {
            ...
            if (options.skippableId) {
                html += `<div class="twcheese-suggest-redirect-skip-container">
                    ...
                    <span>La prochaine fois, ne demande pas, emmène-moi directement là-bas.</span>
                </div>`
            }
            return html;
        }
        ...
        async function alertPremiumRequired() {
            let message = `
                Ce script utilise des fonctionnalités uniquement disponibles pour les utilisateurs <a href="game.php?screen=premium">Premium</a>.
                <br/>
                <p style="font-size: 10px;">
                    Pour 999$, tu pourrais acheter un support d'écran
                    <br/>Ou plus de <strong>30 ans</strong> de compte premium !
                </p>`;
            
            let buttonText = `J'ai l'air de quelqu'un qui gagne de l'argent ?`;
        ...
        function useTool() {
            ...
            if (!document.getElementById('commands_table')) {
                window.UI.ErrorMessage(`Úgy tűnik nincs egyetlen parancs sem.`, 3000);
                return;
            }
